        ...
        <DefaultLayout>
            ...
            <section className="py-16 bg-mfk-blue/5">
                <div className="container mx-auto px-4 max-w-4xl text-gray-800 leading-relaxed">
                    ...
                    <p className="mb-8">🖼️ <em>اقتراح صور:</em>
                        جدار مطلي بالرمادي الدخاني – خلفية تلفاز بلون كحلي – غرفة نوم عاجية مع نجف ذهبي.
                    </p>

                    <h2 className="text-xl font-semibold mt-10 mb-2">🏛️ أين يمكن استخدام الدهانات الفخمة؟</h2>
                    <ul className="list-disc pl-6 mb-6">
